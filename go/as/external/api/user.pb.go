...
type UserListItem struct {
	...
	Organizations        *UserOrganization    `protobuf:"bytes,10,opt,name=organizations,proto3" json:"organizations,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *UserListItem) GetOrganizations() *UserOrganization {
	if m != nil {
...
type CreateUserRequest struct {
	...
	Organizations        *UserOrganization `protobuf:"bytes,3,opt,name=organizations,proto3" json:"organizations,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
type GetUserResponse struct {
	...
	Organizations        *UserOrganization    `protobuf:"bytes,4,opt,name=organizations,proto3" json:"organizations,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *GetUserResponse) GetOrganizations() *UserOrganization {
	if m != nil {
		return m.Organizations
	}
	return nil
...
var fileDescriptor_213a97a4df8a40e1 = []byte{
	...
	,
}
