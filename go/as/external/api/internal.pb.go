...
func (m *MQTTConnectAuthRequest) Reset()         { *m = MQTTConnectAuthRequest{} }
func (m *MQTTConnectAuthRequest) String() string { return proto.CompactTextString(m) }
func (*MQTTConnectAuthRequest) ProtoMessage()    {}
func (*MQTTConnectAuthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d2de8ef40b5c6ca, []int{15}
}

func (m *MQTTConnectAuthRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MQTTConnectAuthRequest.Unmarshal(m, b)
}
func (m *MQTTConnectAuthRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MQTTConnectAuthRequest.Marshal(b, m, deterministic)
}
func (m *MQTTConnectAuthRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MQTTConnectAuthRequest.Merge(m, src)
}
func (m *MQTTConnectAuthRequest) XXX_Size() int {
	return xxx_messageInfo_MQTTConnectAuthRequest.Size(m)
}
func (m *MQTTConnectAuthRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_MQTTConnectAuthRequest.DiscardUnknown(m)
}

var xxx_messageInfo_MQTTConnectAuthRequest proto.InternalMessageInfo

func (m *MQTTConnectAuthRequest) GetUsername() string {
	if m != nil {
		return m.Username
	}
	return ""
...
func (m *MQTTConnectAuthRequest) GetPassword() string {
	if m != nil {
		return m.Password
	}
	return ""
...
func (m *MQTTConnectAuthRequest) GetClientId() string {
	if m != nil {
		return m.ClientId
	}
	return ""
...
type MQTTConnectAuthItem struct {
...
func (m *MQTTConnectAuthItem) Reset()         { *m = MQTTConnectAuthItem{} }
func (m *MQTTConnectAuthItem) String() string { return proto.CompactTextString(m) }
func (*MQTTConnectAuthItem) ProtoMessage()    {}
func (*MQTTConnectAuthItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d2de8ef40b5c6ca, []int{16}
}

func (m *MQTTConnectAuthItem) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MQTTConnectAuthItem.Unmarshal(m, b)
}
func (m *MQTTConnectAuthItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MQTTConnectAuthItem.Marshal(b, m, deterministic)
}
func (m *MQTTConnectAuthItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MQTTConnectAuthItem.Merge(m, src)
}
func (m *MQTTConnectAuthItem) XXX_Size() int {
	return xxx_messageInfo_MQTTConnectAuthItem.Size(m)
}
func (m *MQTTConnectAuthItem) XXX_DiscardUnknown() {
	xxx_messageInfo_MQTTConnectAuthItem.DiscardUnknown(m)
}

var xxx_messageInfo_MQTTConnectAuthItem proto.InternalMessageInfo

func (m *MQTTConnectAuthItem) GetAction() string {
	if m != nil {
		return m.Action
	}
	return ""
...
func (m *MQTTConnectAuthItem) GetIp() string {
	if m != nil {
		return m.Ip
	}
	return ""
...
func (m *MQTTConnectAuthItem) GetTopics() []string {
	if m != nil {
		return m.Topics
	}
	return nil
...
type MQTTConnectAuthResponse struct {
	AuthType             string                 `protobuf:"bytes,1,opt,name=auth_type,json=authType,proto3" json:"auth_type,omitempty"`
	Result               []*MQTTConnectAuthItem `protobuf:"bytes,2,rep,name=result,proto3" json:"result,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}

func (m *MQTTConnectAuthResponse) Reset()         { *m = MQTTConnectAuthResponse{} }
func (m *MQTTConnectAuthResponse) String() string { return proto.CompactTextString(m) }
func (*MQTTConnectAuthResponse) ProtoMessage()    {}
func (*MQTTConnectAuthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d2de8ef40b5c6ca, []int{17}
}

func (m *MQTTConnectAuthResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_MQTTConnectAuthResponse.Unmarshal(m, b)
}
func (m *MQTTConnectAuthResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MQTTConnectAuthResponse.Marshal(b, m, deterministic)
}
func (m *MQTTConnectAuthResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MQTTConnectAuthResponse.Merge(m, src)
}
func (m *MQTTConnectAuthResponse) XXX_Size() int {
	return xxx_messageInfo_MQTTConnectAuthResponse.Size(m)
}
func (m *MQTTConnectAuthResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MQTTConnectAuthResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MQTTConnectAuthResponse proto.InternalMessageInfo

func (m *MQTTConnectAuthResponse) GetAuthType() string {
	if m != nil {
		return m.AuthType
	}
	return ""
...
func (m *MQTTConnectAuthResponse) GetResult() []*MQTTConnectAuthItem {
	if m != nil {
		return m.Result
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MQTTConnectAuthRequest)(nil), "api.MQTTConnectAuthRequest")
	proto.RegisterType((*MQTTConnectAuthItem)(nil), "api.MQTTConnectAuthItem")
	proto.RegisterType((*MQTTConnectAuthResponse)(nil), "api.MQTTConnectAuthResponse")
}
...
var fileDescriptor_2d2de8ef40b5c6ca = []byte{
	...
	,
}
...
type InternalServiceClient interface {
	...
	// MQTT connect auth and return acl.
	MQTTConnectAuth(ctx context.Context, in *MQTTConnectAuthRequest, opts ...grpc.CallOption) (*MQTTConnectAuthResponse, error)
}
...
func (c *internalServiceClient) MQTTConnectAuth(ctx context.Context, in *MQTTConnectAuthRequest, opts ...grpc.CallOption) (*MQTTConnectAuthResponse, error) {
	out := new(MQTTConnectAuthResponse)
	err := c.cc.Invoke(ctx, "/api.InternalService/MQTTConnectAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InternalServiceServer interface {
	...
	// MQTT connect auth and return acl.
	MQTTConnectAuth(context.Context, *MQTTConnectAuthRequest) (*MQTTConnectAuthResponse, error)
}
...
func (*UnimplementedInternalServiceServer) MQTTConnectAuth(ctx context.Context, req *MQTTConnectAuthRequest) (*MQTTConnectAuthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MQTTConnectAuth not implemented")
}
...
func _InternalService_MQTTConnectAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MQTTConnectAuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InternalServiceServer).MQTTConnectAuth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.InternalService/MQTTConnectAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InternalServiceServer).MQTTConnectAuth(ctx, req.(*MQTTConnectAuthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _InternalService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MQTTConnectAuth",
			Handler:    _InternalService_MQTTConnectAuth_Handler,
		},
	},
